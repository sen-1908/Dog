    ...
    <div class="row justify-content-center">
        ...
        <div class="card" style="width: 100%;">
            ...
            <form class="form-inline" method="GET" action=" {{route('index')}} ">
                        <input class="form-control" type="search" placeholder="タイトル名で検索" aria-label="Search" name='search' style="width: 20rem;">
                        <button class="btn btn-outline-success my-2 my-sm-0" style="width: 10rem;" type="submit">検索</button>
                    </form>
